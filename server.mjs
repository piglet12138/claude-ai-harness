...
const agenticSystemPromptText = [
  ...
  "  // 圆形图标徽章 + 卡片",
  "  s.addShape(p.shapes.ROUNDED_RECTANGLE,{x:0.7,y:2,w:3.9,h:2.2,fill:{color:WHITE},rectRadius:0.1,shadow:shadow()});",
  "  s.addShape(p.shapes.OVAL,{x:1.0,y:2.3,w:0.9,h:0.9,fill:{color:TEAL},shadow:shadow()});",
  ...
  "**安全红线**：① 画布 13.33×7.5，生成后自检每个元素 x+w ≤ 13.13 且 y+h ≤ 7.3（留 ~0.2 边距），越界就缩小/换页（无预览、越界会被裁且不报错）；② shadow 用工厂函数、勿复用同一对象；③ ShapeType.line 的 w/h 不能为负（朝左/上用 beginArrowType:'triangle'）；④ 颜色十六进制不带 #；⑤ 元素间留 ≥0.2 间距、不重叠。",
  "",
